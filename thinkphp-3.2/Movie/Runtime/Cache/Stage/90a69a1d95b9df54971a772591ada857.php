				...
				<!-- /movie-browse-agile -->
				      ...
				      <div class="movie-browse-agile">
						...
						<div class="container">
							...
							<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.html" class="hvr-shutter-out-horizontal"><img src="../../Public/images/<?php echo ($vo["movie_photo"]); ?>" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.html"><?php echo ($vo["movie_name"]); ?></a></h6>							
										</div>
										<div class="mid-2">
										
											<p><?php echo ($vo["movie_date"]); ?></p>
                 ...
                 <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ne): $mod = ($i % 2 );++$i;?><div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="single.html"><?php echo ($ne["movie_name"]); ?></a></h6>							
								</div>
